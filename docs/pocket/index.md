...
- Pandas / ETL:
  - [/docs/pocket/log_message_merge_qc](/docs/pocket/log_message_merge_qc) — logging + QA pre/post-merge.
  - [/docs/pocket/concat_csv_patterns](/docs/pocket/concat_csv_patterns), [/docs/pocket/loading_loop_datasets](/docs/pocket/loading_loop_datasets).
...
- Charts & Geo:
  ...
  - Geo pre-checks y overlays: [/docs/pocket/geo_plot_prechecks](/docs/pocket/geo_plot_prechecks), [/docs/pocket/geo_overlay_scatter_box](/docs/pocket/geo_overlay_scatter_box), [/docs/pocket/geopandas_hatches](/docs/pocket/geopandas_hatches).

## Cross-refs
- Métodos: [/docs/metodos/charts_and_styles](/docs/metodos/charts_and_styles), [/docs/metodos/etl_json_policies](/docs/metodos/etl_json_policies), [/docs/metodos/geo_integration_methods](/docs/metodos/geo_integration_methods), [/docs/metodos/temporal_toolkit](/docs/metodos/temporal_toolkit)
- Operación: [/docs/operacion/ci_github_actions](/docs/operacion/ci_github_actions), [/docs/operacion/logging_etl](/docs/operacion/logging_etl)
